...
public class CustomerService : ICustomerService
{
    ...
    private readonly ISqsMesseger _sqsMesseger;

    public CustomerService(ICustomerRepository customerRepository,
        IGitHubService gitHubService, ISqsMesseger sqsMesseger)
    {
    ...
    public async Task<bool> UpdateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await _sqsMesseger.SendMessageAsync(customer.ToCustomerUpdatedMessage());
        }
